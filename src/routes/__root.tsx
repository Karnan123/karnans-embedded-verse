...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Karnan Thamilchelvan — Engineering Portfolio" },
      { property: "og:description", content: "Embedded Systems • Robotics • PCB Design • FPGA • Industrial Automation" },
